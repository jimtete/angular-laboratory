...
using System.Text;
using LearningLab.Assets.Repositories.AssetQueryRepository;
...
builder.Services.AddScoped<ICampaignMapPinRepository, CampaignMapPinRepository>();
builder.Services.AddScoped<ICampaignMilestoneRepository, CampaignMilestoneRepository>();
builder.Services.AddScoped<ICampaignPresentationRepository, CampaignPresentationRepository>();
builder.Services.AddScoped<ICampaignNpcRepository, CampaignNpcRepository>();
builder.Services.AddScoped<ICampaignParticipationInviteRepository, CampaignParticipationInviteRepository>();
builder.Services.AddScoped<ICampaignQuestRepository, CampaignQuestRepository>();
builder.Services.AddScoped<ICampaignQuestTaskRepository, CampaignQuestTaskRepository>();
...
builder.Services.AddScoped<IStoryBlockMusicFileRepository, StoryBlockMusicFileRepository>();
...
builder.Services.AddScoped<ICampaignMapPinService, CampaignMapPinService>();
