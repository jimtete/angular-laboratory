...
public sealed class DisablePresentationModeAction
    : PresentAction<PresentationModeWorkspaceResponse>
{
    ...
    public DisablePresentationModeAction(
    ...
    {
        var presentationResult = await _campaignPresentationService.DisablePresentationModeAsync(
            userId,
            campaignId,
            sessionId,
            cancellationToken);
